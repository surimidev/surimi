...
export type MixinConstructor<
  ...
  // biome-ignore lint/complexity/noBannedTypes: default base must accept anything that can be extended
  TBase = {},
  // biome-ignore lint/suspicious/noExplicitAny: typescript mixins only work with an `any` spread constructor
