...
describe('Compiler', () => {
  ...
  describe('Simple compilation', () => {
    ...
    it('should handle empty CSS files', async () => {
      ...
      expect(result?.js).toContain('// Auto-generated by @surimi/compiler');
    });
  });
  ...
  describe('Dependencies tracking', () => {
    it('should track file dependencies', async () => {
      ...
      const hasRelevantDeps = result?.dependencies.some((dep: string) =>
        dep.includes('.css.ts') || dep.includes('surimi') || dep.includes('simple')
      );
    ...
    it('should track dependencies for files with imports', async () => {
      ...
      const hasImportedFile = dependencyPaths?.some((dep: string) =>
        dep.includes('simple.css.ts') || dep.includes('with-imports.css.ts')
      );
    ...
    it('should not include node_modules in dependencies', async () => {
      ...
      const hasNodeModules = result?.dependencies.some((dep: string) =>
  ...
  describe('Output format', () => {
    ...
    it('should include proper headers in JS output', async () => {
      const result = await compile(createOptions('simple.css.ts'));
  ...
  describe('Error scenarios', () => {
    it('should handle non-existent files gracefully', async () => {
      await expect(
        compile(createOptions('non-existent-file.css.ts'))
      ).rejects.toThrow();
    });
