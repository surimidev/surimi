...
> If you have feedback or issues, open an issue on [GitHub](janis-me/surimi)
...
It supports all vite-compatible frameworks like React, Vue, Svelte, Astro etc. with configuration options for custom requirenemts.
