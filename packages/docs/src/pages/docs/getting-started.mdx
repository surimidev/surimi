...
And that's it! The Surimi file will be automatically compiled (with HMR support), and exports from the file will be preserved (With some [exceptions](/docs/comiler#limitations)).
